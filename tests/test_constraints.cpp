...
//
// For each of the 62 algorithms the same seed is run twice — once with
...
// solutions" — is a heuristic that holds for 61 of the 62, not a theorem. For
...
void probe(const char* name)
{
    ...
    // suites ever executed CDP or EPS_CONSTRAINT for most of the 62 — a
