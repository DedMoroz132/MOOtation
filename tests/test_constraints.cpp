...
//
// For each of the 63 algorithms the same seed is run twice — once with
...
// solutions" — is a heuristic that holds for 62 of the 63, not a theorem. For
...
void probe(const char* name)
{
    ...
    // suites ever executed CDP or EPS_CONSTRAINT for most of the 63 — a
