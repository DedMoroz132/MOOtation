...
const ScaleExempt SCALE_EXEMPT[] = {
    ...
    {"sms_emoa",
     "from three objectives the reference point is nad(Q) + (1, ..., 1) "
     "(EJOR 2007, Sec. 2.1.3), an absolute offset in objective space "
     "(measured: 0.8 % of the mean error at 2^10); at two it has none (SMS-4)"},
    {"r2ibea",
